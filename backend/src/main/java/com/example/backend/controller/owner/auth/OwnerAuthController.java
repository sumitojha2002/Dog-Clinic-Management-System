...
public class OwnerAuthController {
    ...
    public ResponseEntity<?> ownerLogin(@RequestBody LoginDTO logindto){
        try{
            ...
            String refreshToken = jwtService.generateAccessToken(userDetails.getUsername(),userDetails.getAuthorities());
    ...
    public ResponseEntity<?> refresh(@CookieValue("refreshToken") String refreshToken){
        try{
            if(jwtService.validToken(refreshToken) && jwtService.validRefreshToken(refreshToken)){
                ...
                String newRefreshToken = jwtService.generateAccessToken(userDetails.getUsername(), userDetails.getAuthorities());
            ...
            e.printStackTrace();
            return Response.ResponseHandler("Somehing went wrong.", HttpStatus.UNAUTHORIZED);
        }
    }
