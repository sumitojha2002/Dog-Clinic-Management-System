...
public class AdminCategoriesController {
    ...
    public ResponseEntity<?> getAllCategories(@Valid @ModelAttribute CreateCategoryDTO createCategoryDTO,@PathVariable Long id){
        return categoryService.updateCategory(createCategoryDTO, id);
    }
